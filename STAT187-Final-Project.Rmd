...
This data is interesting because it is the kind of data that could be useful to psychologists and social workers. It offers insight to groups of couples and it is purely categorical data. The cleaning that we did in the data was to remname the columns because the original column name we the survey questions separated by periods and they were very long. We also removed the first row as it served as almost a second title row but was being couted in the rows of data. We considerred labeling the blank / no answer spaces as N/A but N/A means something in this data as it is a valid response to specific check boxes. 
...
#sleeping_alone_data %>% mutate(c(How_Often_Sep_Beds!="Never")) 
...
ggplot(data = sleeping_alone_data, 
  ...
  scale_color_discrete(name = "Age", labels = c("No Answer", "Over 60 ", "18-29", "30-44", "45-60" ))

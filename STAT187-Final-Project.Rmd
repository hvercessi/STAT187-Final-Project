...
sleeping_sep_ML <- sleeping_alone_data %>% select(How_Often_Sep_Beds, Relationship_Status, Relationship_Length, Age, Current_Occupation)
...
holdout_sleeping <- holdout_split(df = sleeping_sep_ML, pred = "How_Often_Sep_Beds", train_percent = 0.80)

...
## 2.1 Length of Relationship and Age:  
...
## 2.3 Reasons for Sleeping Separately
...
## 3.4 Evaluating Model Performance: Confusion Matrix
...
the reasons why couples choose to sleep separately. It seems that the reasons are highly

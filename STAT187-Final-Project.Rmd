...
#   theme(legend.position = "NA") +
# 
#   labs(title = "Age, Frequency Sleeping in Separate Beds, and When it Started")
# 
# start_and_age_graph
...
length_and_start_graph <-
  ...
  scale_x_discrete(name = "Relationship Length (years)", labels = c("NA", "1-5", "11-15", "16-20", "6-10","< 1", "> 20" )) +
